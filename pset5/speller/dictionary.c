...
const unsigned int N = 17576; //65536 for the super fast hash function;
...
// Hashes word to a number (this version is slow, but functions) (26^3 buckets needed)
// TIME IN TOTAL : 8.18 (LALALAND.TXT)
//
...
// Good Hashing function retrieved from:
// https://www.reddit.com/r/cs50/comments/1x6vc8/pset6_trie_vs_hashtable/
// TIME IN TOTAL : 0.08 (LALALAND.TXT)
//
//unsigned int hash(const char *word)
//{
